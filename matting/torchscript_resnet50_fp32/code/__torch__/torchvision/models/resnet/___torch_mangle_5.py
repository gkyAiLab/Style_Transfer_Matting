class Bottleneck(Module):
  ...
  downsample : None
  stride : int
  conv1 : __torch__.torch.nn.modules.conv.___torch_mangle_4.Conv2d
  ...
  conv3 : __torch__.torch.nn.modules.conv.___torch_mangle_2.Conv2d
  bn3 : __torch__.torch.nn.modules.batchnorm.___torch_mangle_3.BatchNorm2d
  relu : __torch__.torch.nn.modules.activation.ReLU
  def forward(self: __torch__.torchvision.models.resnet.___torch_mangle_5.Bottleneck,
    x: Tensor) -> Tensor:
